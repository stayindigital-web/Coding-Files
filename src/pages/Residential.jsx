...
function Residential() {
  ...
  <div className="relative w-full h-72 md:h-96">
    <img
      src="src/assets/IX4A0401.jpg"   alt="Recidalcial Design Banner"
...
{/* Text Overlay */}
  ...
  <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center">
    ...
    <div className="flex justify-center">
      <img
        src="../../public/assets/IX4A0378(2).jpg"
      ...
      <div className="bg-gray-50 py-16 px-6">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
            ...
            <img
             src="../../public/assets/IX4A0363(2).jpg" alt="" className='h-60 w-auto mx-auto'/>
          </div>

          {/* Card 2 */}
          <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
           <img 
           src="../../public/assets/IX4A0401.jpg" alt="  " className='h-60 w-auto mx-auto' />
          </div>
