...
import { useNavigate } from "react-router-dom";
 ...
 function Commercial() {
  ...
  <div className="relative w-full h-72 md:h-96">
    <img
      src="../../public/assets/IX4A0406.jpg"   alt="commercial Design Banner"
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center responsive-text responsive-padding responsive-margin ">
      ...
      <p className="mt-3 text-lg md:text-xl text-white drop-shadow-lg max-w-2xl  ">
  ...
  <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center">
    ...
    <div className="flex justify-center">
      <img
         src="../../public/assets/IX4A0406.jpg"
          alt="commercial Design"
        className="rounded-lg shadow-lg w-full h-auto object-cover border-4 border-green-200"/>
    </div>
    ...
    <div>
      ...
      <p className="text-gray-700 p-10px m-10px mb-6 leading-relaxed">
        At Stallion shelters Interior Decorators, we transform your ideas into reality. 
      ...
      <button onClick={()=>{navigate("/commercial")}} className="mt-6 px-6 py-3 bg-orange-500 text-black font-semibold rounded-lg hover:bg-orange transition">
        Contact Us
      </button>
    </div>
      </div>
            ...
            <div className="bg-gray-50 py-16 px-6">
              ...
              <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
                  ...
                  <img
                   src="../../public/assets/IX4A0381.jpg" alt="" className="h-60 w-auto mx-auto" />
                </div>
      
                {/* Card 2 */}
                <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
                 <img 
                 src="../../public/assets/IX4A0378(2).jpg" alt="" className="h-60 w-auto mx-auto" />
                </div>
      
                {/* Card 3 */}
                <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
                  <img
                    src="../../public/assets/IX4A0404.jpg" alt="" className="h-60 w-auto mx-auto" />
                </div>
              </div>
            </div>
     </div>
